...
# 定义匹配变量（协变量）- 只使用4个变量
covariates = ['ln_pgdp', 'ln_pop_density', 'industrial_advanced', 'ln_fdi_openness']
...
# 保存匹配后的数据
output_file = 'results_4vars/CEADs_PSM_matched_data_4vars.xlsx'
...
# 保存平衡性检验结果
balance_summary.to_excel('results_4vars/PSM_balance_test_results_4vars.xlsx', index=False)
print(f"\n平衡性检验结果已保存: results_4vars/PSM_balance_test_results_4vars.xlsx")
...
plt.tight_layout()
plt.savefig('results_4vars/PSM_covariate_distribution_4vars.png', dpi=300, bbox_inches='tight')
print("协变量分布对比图已保存: results_4vars/PSM_covariate_distribution_4vars.png")
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('results_4vars/PSM_standardized_bias_trend_4vars.png', dpi=300, bbox_inches='tight')
print("标准化偏差趋势图已保存: results_4vars/PSM_standardized_bias_trend_4vars.png")
...
print(f"2. results_4vars/PSM_balance_test_results_4vars.xlsx - 平衡性检验详细结果")
print(f"3. results_4vars/PSM_covariate_distribution_4vars.png - 协变量分布对比图")
print(f"4. results_4vars/PSM_standardized_bias_trend_4vars.png - 标准化偏差趋势图")
