...
# 保存平衡性检验结果
balance_summary.to_excel('PSM_balance_test_results_winsorized.xlsx', index=False)
print(f"\n平衡性检验结果已保存: PSM_balance_test_results_winsorized.xlsx")
...
plt.tight_layout()
plt.savefig('PSM_covariate_distribution_winsorized.png', dpi=300, bbox_inches='tight')
print("协变量分布对比图已保存: PSM_covariate_distribution_winsorized.png")
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('PSM_standardized_bias_trend_winsorized.png', dpi=300, bbox_inches='tight')
print("标准化偏差趋势图已保存: PSM_standardized_bias_trend_winsorized.png")
