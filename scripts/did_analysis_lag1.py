...
# 读取去重后的PSM匹配数据（使用DID_lag1）
df = pd.read_excel('results_lag1/CEADs_PSM_matched_data_dedup_lag1.xlsx')
...
print("\n系数对比图已保存: results_lag1/DID_lag1_coefficients_comparison.png")
...
print("\n回归结果已保存到: results_lag1/PSM_DID_regression_results_lag1.xlsx")

print(f"\n{'=' * 80}")
print("PSM-DID分析完成！")
print(f"{'=' * 80}")
print(f"\n输出文件:")
print(f"1. results_lag1/PSM_DID_regression_results_lag1.xlsx - 完整回归结果")
print(f"2. results_lag1/DID_lag1_coefficients_comparison.png - 系数对比图")
