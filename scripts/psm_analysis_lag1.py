...
# 保存匹配后的数据
output_file = 'results_lag1/CEADs_PSM_matched_data_lag1.xlsx'
...
# 保存平衡性检验结果
balance_summary.to_excel('results_lag1/PSM_balance_test_results_lag1.xlsx', index=False)
print(f"\n平衡性检验结果已保存: results_lag1/PSM_balance_test_results_lag1.xlsx")
...
plt.tight_layout()
plt.savefig('results_lag1/PSM_covariate_distribution_lag1.png', dpi=300, bbox_inches='tight')
print("协变量分布对比图已保存: results_lag1/PSM_covariate_distribution_lag1.png")
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('results_lag1/PSM_standardized_bias_trend_lag1.png', dpi=300, bbox_inches='tight')
print("标准化偏差趋势图已保存: results_lag1/PSM_standardized_bias_trend_lag1.png")
...
print(f"2. PSM_balance_test_results_winsorized.xlsx - 平衡性检验详细结果")
print(f"3. PSM_covariate_distribution_winsorized.png - 协变量分布对比图")
print(f"4. PSM_standardized_bias_trend_winsorized.png - 标准化偏差趋势图")
